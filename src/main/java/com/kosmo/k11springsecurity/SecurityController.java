...
public class SecurityController {
    ...
    */
	...
	/*
	 * @RequestMapping("/security2/index.do") public String securityIndex2(Principal
	 * principal, Authentication authentication, Model model) { return
	 * "09Security/Step2/index"; }
	 * 
	 * @RequestMapping("/security2/login.do") public String
	 * securityIndex2Login(Model model, Principal principal) { return
	 * "09Security/Step2/login"; }
	 */
   ...
   public String securityIndex2_1(Principal principal,
	   ...
	   /*
	    ...
	    @Controller로 선언된 클래스에서는 메소드 인자로 Principal
	    	객체를 통해 사용자 아이디를 얻어올 수 있다. 
	    */
	   ...
	   /*
	    일반적인 클래스에서 사용자 정보 얻어오기
	     : 스프링 컨테이너의 전역변수로 선언된 SecurityContextHolder 객체를 이용해서
	     사용자 아이디를 얻어올 수 있다.
